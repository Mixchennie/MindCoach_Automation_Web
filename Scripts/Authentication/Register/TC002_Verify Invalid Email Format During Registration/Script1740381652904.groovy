...
WebUI.setText(findTestObject("Authentication/Register_Page/txt_Email"), 'xuomgmail.com') 
...
boolean isErrorDisplayed = WebUI.waitForElementVisible(findTestObject("Authentication/Register_Page/msg_InvalidEmail"), 10)

if (isErrorDisplayed) {
	WebUI.comment("✅ Invalid email error message is displayed!")
} else {
	WebUI.comment("❌ Invalid email error message is NOT displayed!")
